dungeon_loot.registered_loot = {
	...
	{name = "bucket:water", chance = 0.45, types = {"sandstone", "desert"}},
	{name = "bucket:water", chance = 0.45, y = {0, 32768}, types = {"normal"}},
	{name = "bucket:lava", chance = 0.45, y = {-32768, -1}, types = {"normal"}},
