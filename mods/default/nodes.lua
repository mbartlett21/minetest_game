...
minetest.register_node("default:stone", {
	...
	groups = {cracky = 3, stone = 1, creative = 1},
	drop = 'default:cobble',
	legacy_mineral = true,
...
minetest.register_node("default:cobble", {
	...
	is_ground_content = false,
	groups = {cracky = 3, stone = 2, creative = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:sandstone", {
	...
	groups = {crumbly = 1, cracky = 3, creative = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:dirt", {
	...
	groups = {crumbly = 3, soil = 1, creative = 1},
...
minetest.register_node("default:stones", {
	description = "Stones",
	tiles = {"default_stone.png"},
	...
	node_box = {
		type = "fixed",
		fixed = {
            {-1/2,  -1/2,  1/16, -3/16, -5/16,  5/16},
            {-5/16, -1/2, -5/16, -1/8,  -3/8,  -1/16},
            {-1/4,  -1/2,  5/16,  3/16, -3/8,   1/2},
            { 0,    -1/2, -5/16,  1/4,  -3/8,  -1/8},
            { 3/16, -1/2,  0,     3/8,  -3/8,   1/4},
            { 1/4,  -1/2, -7/16,  7/16, -7/16, -1/4}
		},
	},
})
...
minetest.register_node("default:sand", {
	...
	groups = {crumbly = 3, falling_node = 1, sand = 1, creative = 1},
...
minetest.register_node("default:snow", {
	...
	groups = {crumbly = 3, falling_node = 1, snowy = 1, creative = 1},
...
minetest.register_node("default:snow_block", {
	...
	tiles = {"default_snow.png"},
	groups = {crumbly = 3, cools_lava = 1, snowy = 1, creative = 1},
	sounds = default.node_sound_snow_defaults(),
...
minetest.register_node("default:ice", {
	...
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky = 3, cools_lava = 1, slippery = 3, creative = 1},
	sounds = default.node_sound_glass_defaults(),
})
...
minetest.register_node("default:tree", {
	...
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2, creative = 1},
...
minetest.register_node("default:wood", {
	...
	is_ground_content = false,
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, wood = 1, creative = 1},
	sounds = default.node_sound_wood_defaults(),
})
...
minetest.register_node("default:sapling", {
	...
	groups = {snappy = 2, dig_immediate = 3, flammable = 2,
		attached_node = 1, sapling = 1, creative = 1},
...
minetest.register_node("default:leaves", {
	...
	paramtype = "light",
	is_ground_content = false,
	groups = {snappy = 3, leafdecay = 3, flammable = 2, leaves = 1, creative = 1},
	drop = {
		max_items = 1,
		items = {
			{
...
minetest.register_node("default:apple", {
	...
	groups = {fleshy = 3, dig_immediate = 3, flammable = 2,
		leafdecay = 3, leafdecay_drop = 1, food_apple = 1, creative = 1},
	...
	after_dig_node = function(pos, oldnode, oldmetadata, digger)
        if oldnode.param2 ~= 1 then
            ...
            minetest.get_node_timer(pos):start(math.random(150, 500))
        end
	end,
})

-- Marks the position of an apple for grown apples
minetest.register_node("default:apple_mark", {
	...
	after_place_node = function(pos, oldnode, oldmetadata, digger)
        minetest.get_node_timer(pos):start(math.random(150, 500))
	end,
	on_timer = function(pos, elapsed)
		...
		elseif minetest.get_node_light(pos) < 11 then
			minetest.get_node_timer(pos):start(100)
		else
...
minetest.register_node("default:large_cactus_seedling", {
	...
	on_construct = function(pos)
		...
		-- 14 * 199.2 = 2788.8s.
		-- Set random range to average to 2789s (~ 47 minutes).
	...
	on_timer = function(pos)
		...
		minetest.log("action", "[default] A large cactus seedling grows into a large" ..
...
minetest.register_node("default:papyrus", {
	...
	groups = {snappy = 3, flammable = 2, creative = 1},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("default:dry_shrub", {
	...
	buildable_to = true,
    floodable = true,
	groups = {snappy = 3, flammable = 3, attached_node = 1, creative = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:junglegrass", {
	...
	buildable_to = true,
    floodable = true,
	groups = {snappy = 3, flora = 1, attached_node = 1, flammable = 1, creative = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
		fixed = {-6 / 16, -0.5, -6 / 16, 6 / 16, 0.5, 6 / 16},
...
minetest.register_node("default:grass_1", {
	...
	buildable_to = true,
    floodable = true,
	groups = {snappy = 3, flora = 1, attached_node = 1, grass = 1, flammable = 1, creative = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:dry_grass_1", {
	...
	groups = {snappy = 3, flammable = 3, flora = 1,
		attached_node = 1, dry_grass = 1, creative = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
		fixed = {-6 / 16, -0.5, -6 / 16, 6 / 16, -3 / 16, 6 / 16},
...
minetest.register_node("default:fern_1", {
	...
	buildable_to = true,
    floodable = true,
	groups = {snappy = 3, flammable = 3, flora = 1, attached_node = 1, creative = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:bush_stem", {
	...
	paramtype = "light",
	sunlight_propagates = true,
	groups = {choppy = 2, oddly_breakable_by_hand = 1, flammable = 2, creative = 1},
	sounds = default.node_sound_wood_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:bush_leaves", {
	...
	paramtype = "light",
	groups = {snappy = 3, flammable = 2, leaves = 1, creative = 1},
	drop = {
		max_items = 1,
		items = {
...
minetest.register_node("default:blueberry_bush_leaves_with_berries", {
	...
	paramtype = "light",
	groups = {snappy = 3, flammable = 2, leaves = 1, dig_immediate = 3, creative = 1},
...
local function register_sign(material, desc, def)
	minetest.register_node("default:sign_wall_" .. material, {
		...
		on_receive_fields = function(pos, formname, fields, sender)
			...
			minetest.log("action", "[default] " .. (player_name or "") .. " wrote \"" .. text .. "\" to sign at " .. minetest.pos_to_string(pos))
			local meta = minetest.get_meta(pos)
...
register_sign("wood", "Wooden", {
	sounds = default.node_sound_wood_defaults(),
	groups = {choppy = 2, attached_node = 1, flammable = 2, oddly_breakable_by_hand = 3, creative = 1}
})
...
minetest.register_node("default:ladder_wood", {
	...
	groups = {choppy = 2, oddly_breakable_by_hand = 3, flammable = 2, creative = 1},
	sounds = default.node_sound_wood_defaults(),
})
...
if default.register_fence then
    default.register_fence("wood", {
        ...
        groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, creative = 1},
        sounds = default.node_sound_wood_defaults()
    })

    default.register_fence("acacia_wood", {
    ...
    default.register_fence("junglewood", {
    ...
    default.register_fence("pine_wood", {
    ...
    default.register_fence("aspen_wood", {
    ...
    default.register_fence_rail("wood", {
    ...
    default.register_fence_rail("acacia_wood", {
    ...
    default.register_fence_rail("junglewood", {
    ...
    default.register_fence_rail("pine_wood", {
    ...
    default.register_fence_rail("aspen_wood", {
    ...
    default.register_fence_gate("wood", {
    ...
    default.register_fence_gate("acacia_wood", {
    ...
    default.register_fence_gate("junglewood", {
    ...
    default.register_fence_gate("pine_wood", {
    ...
    default.register_fence_gate("aspen_wood", {
...
minetest.register_node("default:glass", {
	...
	sunlight_propagates = true,
	is_ground_content = false,
	groups = {cracky = 3, oddly_breakable_by_hand = 3, creative = 1},
	sounds = default.node_sound_glass_defaults(),
})
...
if stairs then
    ...
    stairs.register_stair_and_slab(
        "wood",
        "default:wood",
        {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, creative = 1},
        {"default_wood.png"},
        "Wooden Stair",
        "Wooden Slab",
    ...
    stairs.register_stair_and_slab(
        "ice",
        "default:ice",
        {cracky = 3, cools_lava = 1, slippery = 3, creative = 1},
        {"default_ice.png"},
        "Ice Stair",
        "Ice Slab",
    ...
    stairs.register_stair_and_slab(
        "snow_block",
        "default:snow_block",
        {crumbly = 3, cools_lava = 1, snowy = 1, creative = 1},
        {"default_snow.png"},
        "Snow Block Stair",
        "Snow Block Slab",
...
if walls then
    walls.register("cobble", "Cobblestone Wall", {"default_cobble.png"},
            "default:cobble", default.node_sound_stone_defaults(), {stone = 2, creative = 1})

    walls.register("mossycobble", "Mossy Cobblestone Wall", {"default_mossycobble.png"},
            "default:mossycobble", default.node_sound_stone_defaults(), {stone = 2, creative = 1})

    walls.register("desertcobble", "Desert Cobblestone Wall", {"default_desert_cobble.png"},
            "default:desert_cobble", default.node_sound_stone_defaults(), {stone = 2, creative = 1})
end
