...
local is_december = month == 12-- or month == 10

local chest_top = is_december and "default_chest_top_present.png" or "default_chest_top.png"
local chest_side = is_december and "default_chest_side_present.png" or "default_chest_side.png"
local chest_front = is_december and "default_chest_front_present.png" or "default_chest_front.png"
local chest_lock = is_december and "default_chest_lock_present.png" or "default_chest_lock.png"

local chest_node_box = {
        type = "fixed",
        fixed = {
                -- Top
                {-17/32, 3/16, -17/32, 17/32, 1/2, 17/32},
                -- Box
                {-1/2, -1/2, -1/2, 1/2, 3/16, 1/2},
                -- Lock
                {-1/8, 1/16, -17/32, 1/8, 3/16, -1/2}
            }
    }
...
default.chest.register_chest("chest", {
    ...
    drawtype = is_december and "nodebox" or "normal",
    node_box = chest_node_box,
    collision_box = { type = "normal" },
    selection_box = { type = "normal" },
	sounds = default.node_sound_wood_defaults(),
	sound_open = "default_chest_open",
	sound_close = "default_chest_close",
	groups = {choppy = 2, oddly_breakable_by_hand = 2, creative = 1}
})
