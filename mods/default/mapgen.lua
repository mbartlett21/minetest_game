...
minetest.register_alias("mapgen_snowblock", "default:snow_block")
...
minetest.register_alias("mapgen_sandstonebrick", "default:sandstone_brick")
...
function default.register_decorations()
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/apple_tree.mts",
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/apple_log.mts",
	...
	if chunksize >= 5 then
		minetest.register_decoration({
			...
			y_max = 32,
			y_min = 1,
			schematic = default.modpath .. "/schematics/emergent_jungle_tree.mts",
			flags = "place_center_x, place_center_z",
			rotation = "random",
			place_offset_y = -4,
		})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = -1,
		schematic = default.modpath .. "/schematics/jungle_tree.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/jungle_log.mts",
		flags = "place_center_x",
		rotation = "random",
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = default.modpath .. "/schematics/pine_tree.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = default.modpath .. "/schematics/small_pine_tree.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = default.modpath .. "/schematics/pine_log.mts",
		flags = "place_center_x",
		rotation = "random",
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/acacia_tree.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/acacia_log.mts",
		flags = "place_center_x",
		rotation = "random",
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/aspen_tree.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/aspen_log.mts",
		flags = "place_center_x",
		rotation = "random",
		spawn_by = "default:dirt_with_grass",
		num_spawn_by = 8,
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = default.modpath .. "/schematics/large_cactus.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random",
	})
	...
	minetest.register_decoration({
		...
		y_max = 0,
		y_min = 0,
		schematic = default.modpath .. "/schematics/papyrus.mts",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/bush.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_min = 1,
		place_offset_y = 1,
		schematic = default.modpath .. "/schematics/blueberry_bush.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 1,
		schematic = default.modpath .. "/schematics/acacia_bush.mts",
		flags = "place_center_x, place_center_z",
	})
	...
	minetest.register_decoration({
		...
		y_max = 31000,
		y_min = 4,
		schematic = default.modpath .. "/schematics/pine_bush.mts",
		flags = "place_center_x, place_center_z",
	})
