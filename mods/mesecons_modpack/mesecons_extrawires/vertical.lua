...
local vertical_updatepos = function (pos)
	...
	and minetest.registered_nodes[node.name].is_vertical_conductor then
		...
		-- Always place offstate conductor and let mesecons.on_placenode take care
		...
		mesecons.on_placenode(pos, {name = newname})
	end
end
...
-- Vertical wire
mesecons.register_node("mesecons_extrawires:vertical", {
...
-- Vertical wire top
mesecons.register_node("mesecons_extrawires:vertical_top", {
	description = "Vertical mesecon",
	drawtype = "nodebox",
	walkable = false,
	paramtype = "light",
...
mesecons.register_node("mesecons_extrawires:vertical_bottom", {
	description = "Vertical mesecon",
	drawtype = "nodebox",
	walkable = false,
	paramtype = "light",
