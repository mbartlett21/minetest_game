...
minetest.register_node("doors:hidden", {
	...
	floodable = false,
	drop = "",
	groups = {not_in_creative_inventory = 1, fixed = 1},
...
function doors.register(name, def)
	...
	def.groups.door = 1
    -- Stop moving with pistons for now
    def.groups.fixed = 1
	def.drop = name
	def.door = {
		name = name,
...
doors.register_trapdoor("trapdoor_wood", {
...
doors.register_trapdoor("trapdoor_steel", {
	...
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
	groups = {cracky = 1, level = 2, fixed = 1},
})
