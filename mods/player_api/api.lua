...
function player_api.set_model(player, model_name)
	...
	if model then
        ...
        player:set_local_animation(
                model.animations.stand,
                model.animations.walk,
                model.animations.mine,
                model.animations.walk_mine,
...
function player_api.get_model(model_name)
	local model = models[model_name]
    return model
end
...
minetest.register_globalstep(function(dtime)
        for _, player in pairs(minetest.get_connected_players()) do
            ...
            if model and not player_attached[name] then
                ...
                if model.animation_control then
                    model:animation_control(player, controls)
                else
                    local walking = false
                    ...
                    elseif controls.LMB then
                        ...
                        player_set_animation(player, "stand", animation_speed)
                    end
                end
            end
        end
